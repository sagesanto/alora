...
try:
    ...
    from alora.maestro.scheduleLib.candidateDatabase import Candidate, CandidateDatabase, validFields
    from alora.maestro.scheduleLib.genUtils import stringToTime, TypeConfiguration, overlapping_time_windows
